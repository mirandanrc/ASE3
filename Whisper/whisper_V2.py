...
def listening():
    ...
    def callback(in_data, frame_count, time_info, status, amplitud_to_audio, flag_audio_continua):
    ...
    stream = p.open(format=pyaudio.paInt16,
                    ...
                    input=True,
                    frames_per_buffer=CHUNK,
                    stream_callback=lambda in_data, frame_count, time_info, status: callback(in_data, frame_count, time_info, status, amplitud_to_audio, flag_audio_continua))
    ...
    return amplitud_to_audio, amplitud_to_whisper
...
if __name__ == '__main__':
    ...
    amplitud_audio(msg)  # amplitud_to_audio
    amplitude_whisper(msg)  # amplitud_to_whisper
    listening()

    # subscribers audiorecorder
    audio_amplitud(msg)  # audio_to_amplitud
    audio_whisper(msg)  # audio_to_whisper
    recorder()

    # subscribers whisper
    whisper_amplitud(msg)  # whisper_to_amplitud
    whisper_audio(msg)  # whisper_to_audio
    whisper_logic()
